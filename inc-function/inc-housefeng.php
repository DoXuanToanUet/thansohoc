<?php function housefeng(){  ?>
    <div class="housefeng form-common">
        <h2>Xem hướng nhà theo tuổi vợ chồng</h2>
        <div class="housefeng-form">
            <div class="form-inpt">
                ...
                <select class="select_list" name="nam_sinh" id="">
                    ...
                    <option value="quy-dau" selected="">1993</option>
            ...
            <div class="form-inpt">
                ...
                <input type="radio" id="nutvc" name="gioi_tinh" value="nữ"  wfd-invisible="true">
                <label for="nutvc">Nữ</label>
            </div>
            <div class="form-inpt">
                <label for="">Hướng nhà</label>
                <select class="select_list1" name="huong" id="">
                    <option value="7">Đoài - Chính Tây</option>
                    <option value="6">Càn - Tây Bắc</option>
                    <option value="1" selected="">Khảm - Chính Bắc</option>
                    <option value="8">Cấn - Đông Bắc</option>
                    <option value="3">Chấn - Chính Đông</option>
                    <option value="4">Tốn - Đông Nam</option>
                    <option value="9">Ly - Chính Nam</option>
                    <option value="2">Khôn - Tây Nam</option>
                </select>
            </div>
            <div class="btn-dev button__xemngay" value="">Xem ngay</div>
        </div>
    </div>
<?php } add_shortcode("housefeng", "housefeng");?>
