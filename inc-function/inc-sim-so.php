<?php function SimSo(){  ?>
   <div class="simso-section">
        <form action="" autocomplete="on">
            <div class="pytha-title">
                <div class="pytha-icon d-flex">
                    ...
                    <h2>TRA CỨU <br> SIM SỐ</h2>
                </div>
            </div>
         
            <div class="pytha-inpt">
                <label for="ss-name">Tên của bạn</label>
                <input type="text" class="form-control" name="ss-name" id="ss-name" placeholder="Họ tên">
            </div>
            <div class="pytha-inpt">
                <label for="">Ngày sinh</label>
                <div class="form-item d-flex">
                    <select title="Ngày sinh" name="ss-ngay" id="ngay">
                    ...
                    <select title="Tháng sinh" name="ss-thang" id="thang">
            ...
            <div class="pytha-inpt">
                <label class="label-form">Giờ sinh</label>
                <div class="form-item d-flex">
                    <select title="Giờ sinh" name="gio" id="ss-gio">
                        <option value="" selected="">Giờ sinh</option>
                    ...
                    <select title="Phút sinh" name="phut" id="ss-phut">
                        <option value="" selected="">Phút sinh</option>
                        <option value="30">0 -&gt; 30</option>
                        <option value="59" >31 -&gt; 59</option>
                    </select>
                </div>
            </div>
            <div class="pytha-inpt">
                ...
                <div class="form-item d-flex">
                    <div class="male">
                        <input type="radio" id="ss-male" name="gioitinh" value="nam" checked="">
                        <label for="male">Nam</label>
                    </div>
                    <div class="female">
                        <input type="radio" id="ss-female" name="gioitinh" value="nu">
                        <label for="female">Nữ</label>
                    </div>
                </div>
            </div>
            <div value="Xem ngay" id='simso-btn' class="btn-dev">Xem ngay</div>
        ...
        <div class="simso-content">
            
        </div>
   </div>
   
       
<?php } add_shortcode("SimSo", "SimSo");?>
